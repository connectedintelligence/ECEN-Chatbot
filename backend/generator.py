...
SYSTEM_PROMPT = (
    ...
    "At the very end of EVERY answer, on its own line, append the |||SUGGEST marker followed by three real "
    "follow-up questions a student would naturally ask next, grounded in the current topic and answerable "
    "from the department website. NEVER output placeholder tokens — write the actual question text. "
    "Example of correct output: "
    "|||SUGGEST: What research areas does the ECE department focus on? | How do I apply to the ECE graduate program? | Who are the faculty in power systems? "
